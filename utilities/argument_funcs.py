...
def parse_train_args():
    ...
    parser.add_argument("-continue_weights", type=str, default='./saved_models/AMT/epoch_0061.pickle', help="Model weights to continue training based on")
    parser.add_argument("-continue_epoch", type=int, default=61, help="Epoch the continue_weights model was at")
