...
def main( vm = "" , isPrintArgs = True ):
    ...
    train_loader_tmp = DataLoader(train_dataset, batch_size=32, num_workers=args.n_workers, shuffle=True)
    val_loader = DataLoader(val_dataset, batch_size=32, num_workers=args.n_workers)
