...
def main( vm = "", isPrintArgs = True):
    ...
    eval_loss, eval_rmse, eval_rmse_note_density, eval_rmse_loudness, eval_rmse_key, eval_acc_key = eval_model(model, test_loader, loss)
    ...
    logging.info(f"Avg Acc (Key): {eval_acc_key}")
