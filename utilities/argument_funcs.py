...
def parse_train_args():
    ...
    parser.add_argument('-regModel', type=str, default='custom_gru', help="Version name. None is original loudness and note density Regression model")
...
def parse_eval_args():
    ...
    parser.add_argument("-dim_feedforward", type=int, default=1024, help="Dimension of the feedforward layer")
    parser.add_argument('-music_gen_version', type=int, default=1, help="Version number. None is original musgic generation AMT model")
    parser.add_argument('-regModel', type=str, default='custom_gru', help="Version number. None is original loudness and note density Regression model")
