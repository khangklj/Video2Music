...
CSV_HEADER = ["Epoch", "Learn rate", "Avg Train loss", "Avg Train RMSE", "Avg Train RMSE (Note Density)", "Avg Train RMSE (Loudness)", "Avg Train RMSE (Key)",
              "Avg Eval loss", "Avg Eval RMSE", "Avg Eval RMSE (Note Density)", "Avg Eval RMSE (Loudness)", "Avg Eval RMSE (Key)"]
BASELINE_EPOCH = -1
...
def main( vm = "" , isPrintArgs = True ):
    ...
    opt = Lion(model.parameters(), lr=lr, betas=(0.95, 0.98), weight_decay=1.0)
