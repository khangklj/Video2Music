...
def main( vm = "", isPrintArgs = True):
    ...
    model = VideoRegression(n_layers=args.n_layers, d_model=64, use_KAN=use_KAN, max_sequence_video=args.max_sequence_video, total_vf_dim=total_vf_dim, regModel=regModel).to(get_device())
